...
This is a quick reference. The [final schematic](../schemes/schematic.png) is the authority for physical wiring.
...
| MPU6050 I2C bus | 1 | [`src/heaeding.py`](../src/heaeding.py) |
| MPU6050 address | `0x68` | [`src/heaeding.py`](../src/heaeding.py) |
...
- Drive motor uses the raw battery motor branch through the driver.
...
[Open schematic](../schemes/schematic.png)
